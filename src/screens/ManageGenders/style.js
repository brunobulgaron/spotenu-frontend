...
export const ManageGendersWrapper = styled.div `
    /* height: 100%; */
    /* width: 100%; */
    display: grid;
...
export const PaperManageGenders = styled(Paper) `
    display: flex;
...
export const TypographyManageGenders = styled(Typography) `
    text-align: center;
    margin-bottom: 30px;
    margin-top: 30px;
`

export const ButtonManageGenders = styled(Button) `
    color: #fff;
    font-weight: bold;
    width: 50%;
    margin: 8px auto;
...
export const ButtonManageGendersVoltar = styled(Button) `
    color: #25252c;
    font-weight: 600;
    width: 50%;
    margin: 8px auto;
