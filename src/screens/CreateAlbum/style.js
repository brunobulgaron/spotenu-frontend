...
export const PaperCreateAlbum = styled(Paper) `
    display: flex;
...
export const CustomAlbumsWrapper = styled.div `
    display: flex;
    flex-direction: column;
    justify-items: center;
    width: 90%;
...
export const TypographyCreateAlbum = styled(Typography) `
    text-align: center;
    margin-bottom: 30px;
    margin-top: 30px;
`

export const ButtonCreateAlbum = styled(Button) `
    color: #fff;
    font-weight: bold;
    width: 50%;
    margin: 8px auto;
...
export const ButtonCreateAlbumVoltar = styled(Button) `
    color: #25252c;
    font-weight: 600;
    width: 50%;
    margin: 8px auto;
...
export const FormCreateAlbum = styled.form `
    display: flex;
    flex-direction: column;
    gap: 8px;
    padding: 50px;
